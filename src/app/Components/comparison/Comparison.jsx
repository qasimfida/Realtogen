...
import MoneybagIcon from "../../../../public/icons/MoneybagIcon";
import ChartIcon from "../../../../public/icons/ChartIcon";
import WarningIcon from "../../../../public/icons/WarningIcon";
import SheildIcon from "../../../../public/icons/SheildIcon";
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-[16px]">
          ...
          <div className="flex flex-col items-center">
            <Card className="bg-[#2545B7] text-white rounded-2xl pl-[40px] pr-[30px] pt-[30px] pb-[45px] md:w-md ">
              <CardContent className="px-0">
                ...
                <ul className="space-y-3 text-sm text-white text-left">
                  <li className="flex items-center gap-2">
                    <SheildIcon className="text-white mt-1 " />
            ...
            <div className="mt-3 flex flex-col space-y-2 text-sm bg-[#2545B7] p-4 rounded-xl text-white w-full py-6 px-10">
              <div className="flex items-center gap-[38px]">
                <div className="flex items-center gap-[38px]">
                  <DollerIcon />
                  <h3 className="font-semibold text-[24px]">16.90$</h3>
                </div>
              ...
              <div className="flex items-center gap-[44px]">
                <div className="flex items-center gap-[48px]">
                  <SpeedIcon />
                  <h3 className="font-semibold text-[24px]">8 min</h3>
                </div>
                <div className="flex items-center text-[16px] gap-2">
          ...
          <Card className="bg-[#FEF2F2] text-[#141A30] rounded-2xl pl-[40px] pr-[30px] pt-[30px] pb-[45px] md:w-md ">
              <CardContent className="px-0">
                ...
                <ul className="space-y-3 text-sm text-[#141A30] text-left">
                  <li className="flex items-centercenter gap-2">
                    <WarningIcon className="text-white mt-1" />
                    <p className=" text-[16px] font-normal">
                      <span className="font-bold">Instant Results:</span>{" "}
                      Generate aerial-style videos in minutes
                    </p>
            ...
            <div className="mt-3 flex flex-col space-y-2 text-sm bg-[#FEF2F2] p-4 rounded-xl text-[#141A30] w-full py-6 px-10">
              <div className="flex items-center gap-[38px]">
                <div className="flex items-center gap-[38px]">
                  <MoneybagIcon />
                  <h3 className="font-semibold text-[24px]">450$</h3>
                </div>
                <div className="flex items-center text-[16px] gap-2">
                  <p>pro plan price</p>
                </div>
              ...
              <div className="flex items-center gap-[30px]">
                <div className="flex items-center gap-[48px]">
                  <ChartIcon />
                  <h3 className="font-semibold text-[24px]">3 days</h3>
                </div>
                <div className="flex items-center text-[16px] gap-2">
                  <p>average delivery time</p>
                </div>
