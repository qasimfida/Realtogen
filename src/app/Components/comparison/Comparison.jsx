...
const Comparison = () => {
  return (
    <div className=" py-16 md:px-0 px-4 flex items-center">
      <div className="max-w-7xl mx-auto py-10 md:px-12 px-6 text-center bg-white rounded-4xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="flex flex-col items-center">
            <Card className="bg-[#2545B7] text-white rounded-2xl p-6 w-full md:w-md shadow-xl">
          ...
          <div className="flex flex-col items-center">
            <Card className="bg-[#FEF2F2] text-[#141A30] rounded-2xl p-6 w-full md:w-md shadow-none">
              <CardContent className="p-6">
