...
const HomeHero = () => {
  return (
    <>
      <div className="flex justify-center mt-[25px] md:mt-[78px] md:pl-[16px] max-sm:px-[17px]">
        <div className="flex relative pt-[15px] md:pt-[78px] overflow-hidden flex-col-reverse md:flex-row gap-[32px]">
          <div className="absolute top-[16px] left-[250px] max-sm:left-0 max-sm:top-[300px]">
            <Image
              ...
              width={500}
              height={300}
              className="sm:w-[800px] max-sm:w-[400px]"
            />
          </div>
          ...
          <div className="flex flex-col items-center md:items-start z-10">
            ...
            <div className="pt-[24px] md:pt-[32px] w-auto md:w-[406px]">
              <p className="text-[16px] font-medium">
                ...
                <span className="text-[#426BFF] font-bold">
                  -within minutes!
                </span>
              </p>
              <p className="pt-[16px]">
                No filming. No hassle.{" "}
                <span className="font-bold text-[#141A30]">
                  Save time and money
                </span>{" "}
                with Realtogen AI drone shots.
              </p>
            </div>
      ...
      <div className="block md:hidden px-[16px] pt-[40px] md:pt-[101px]">
        <Swiper
        ...
        >
          {CardsData.map((card) => (
            <SwiperSlide key={card.id}>
              <HomeCards text={card.text} img={card.img} />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>

      <div className="max-sm:hidden md:grid px-[16px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[23px] pt-[40px] md:pt-[101px]">
        {CardsData.map((card) => (
