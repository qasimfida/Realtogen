...
export default function VirtualDroneSection() {
  return (
    <section className="max-sm:pt-[62px] max-sm:px-[73px] text-center md:text-start">
      <div className="">
      ...
      <div className="mt-[58px] md:px-[30px] flex flex-col md:flex-row justify-center gap-6">
        <VirtualDroneCard
