...
const StepCard = ({ step, title, description, imageSrc }) => {
  return (
    <div
    className="relative w-[320px]  bg-[#426BFF] rounded-2xl shadow-md max-w-sm h-[351px] pb-4 text-center border flex flex-col"
  ...
  >
    ...
    <p className="text-[#141A30] px-4 text-center text-base mt-2 mx-auto flex-grow">{description}</p>
