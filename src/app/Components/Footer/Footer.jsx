...
const Footer = () => {
  return (
    <div className=" bg-[#141A30] lg:pl-[220px] lg:pr-[196px] px-[14px]">
      <div className="flex flex-col pb-[18px] max-w-[1024px] w-[100%] mx-auto">
        <div className="mx-auto flex flex-col-reverse sm:flex-col sm:items-center md:flex-row max-sm:items-center lg:gap-[208px] sm:gap-[28px] sm:pt-[38px] sm:pb-[19px] ">
          ...
          <div className="mt-[14px]">
            ...
            <div className="mt-[32px] md:mt-[47px] flex justify-between px-[7px] items-center rounded-2xl  bg-white h-[63px] w-[100%] sm:w-[410px] max-sm:px-[13px]">
              <Input
